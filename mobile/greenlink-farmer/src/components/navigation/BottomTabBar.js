...
const QUICK_ACTIONS = {
  farmer: [
    ...
    { name: 'CarbonPayments', icon: 'cash', label: 'Mes Revenus Carbone', color: '#f59e0b' },
    { name: 'CarbonMarketplace', icon: 'storefront', label: 'Marché Carbone', color: '#06b6d4' },
    ...
    { name: 'Orders', icon: 'receipt', label: 'Mes Commandes', color: '#64748b' },
  ],
  cooperative: [
