...
const QUICK_ACTIONS = {
  farmer: [
    ...
    { name: 'USSDCarbon', icon: 'call', label: '*144*99# Prime', color: '#f97316' },
    { name: 'Notifications', icon: 'notifications', label: 'Notifications', color: '#ef4444' },
  ],
  field_agent: [],
  cooperative: [
    { name: 'CoopHarvests', icon: 'checkmark-done-circle', label: 'Valider Recoltes', color: '#059669' },
    { name: 'AddCoopMember', icon: 'person-add', label: 'Nouveau Membre', color: '#10b981' },
    { name: 'AddMemberParcel', icon: 'map', label: 'Ajouter Parcelle', color: '#2196F3' },
    { name: 'CoopLots', icon: 'cube', label: 'Ventes Groupees', color: '#9C27B0' },
    { name: 'CoopDistributions', icon: 'wallet', label: 'Distributions', color: '#FF9800' },
    { name: 'ActivationStats', icon: 'stats-chart', label: 'Suivi Activation', color: '#00BCD4' },
    { name: 'CarbonPremiums', icon: 'leaf', label: 'Primes Carbone', color: '#8BC34A' },
    { name: 'AgentsProgress', icon: 'body', label: 'Suivi Agents', color: '#795548' },
    { name: 'USSDRegistrations', icon: 'phone-portrait', label: 'Inscriptions', color: '#673AB7' },
    { name: 'AgentList', icon: 'people', label: 'Agents Terrain', color: '#3F51B5' },
    { name: 'CoopParcels', icon: 'layers', label: 'Parcelles', color: '#3b82f6' },
...
const BottomTabBar = ({ userType = 'farmer', notifications = {} }) => {
  ...
  const isTabActive = (tabName) => {
    ...
    const relatedScreens = {
      ...
      CoopDashboard: ['CoopDashboard', 'CoopLots', 'CoopDistributions', 'CoopParcels', 'ActivationStats', 'CarbonPremiums', 'AgentsProgress', 'USSDRegistrations'],
      CoopMembers: ['CoopMembers', 'CoopMemberDetail', 'AddMemberParcel', 'AddCoopMember'],
