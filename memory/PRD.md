...
- (6 avr) FIX page blanche Parcelles farmer: L'onglet Parcelles naviguait vers /farmer/parcels/new (route inexistante). Cree un composant FarmerParcelsTab inline qui affiche les parcelles du planteur via /api/greenlink/parcels/my-parcels. Le bouton "Mes Parcelles" du menu Accueil redirige aussi vers cet onglet.
