...
- (6 avr) FIX page blanche Parcelles farmer: L'onglet Parcelles et "Mes Parcelles" dans Plus naviguaient vers /farmer/parcels/new (route inexistante). Cree un composant FarmerParcelsTab inline avec formulaire de declaration de parcelle (localisation, region, culture, superficie, arbres, pratiques agricoles). Score carbone calcule automatiquement par le backend.
