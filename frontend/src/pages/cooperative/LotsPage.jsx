              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="ARS 1000-1">ARS 1000-1 Bronze</SelectItem>
                      <SelectItem value="ARS 1000-2">ARS 1000-2 Argent</SelectItem>
                      <SelectItem value="ARS 1000-3">ARS 1000-3 Or</SelectItem>
