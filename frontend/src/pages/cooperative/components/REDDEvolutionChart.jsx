      ...
      <div className="p-5">
        <ResponsiveContainer width="100%" height={220}>
          <ComposedChart data={data} margin={{ top: 5, right: 10, left: -15, bottom: 0 }}>
            ...
            <Line yAxisId="right" type="monotone" dataKey="score_moyen" name="Score REDD+ /10" stroke="#D4AF37" strokeWidth={2} dot={{ r: 4, fill: '#D4AF37', stroke: '#fff', strokeWidth: 2 }} />
          </ComposedChart>
        </ResponsiveContainer>
        <div className="flex items-center justify-center gap-6 mt-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-[#6B7280]">Score REDD+ /10</span>
          </div>
        </div>
      </div>
    </div>
