...
export const SSRTEWidget = ({ ssrte, ici }) => {
  const navigate = useNavigate();

  if (!ssrte) {
    return (
      <div className="bg-white border border-[#E5E5E0] rounded-md overflow-hidden gl-animate-in gl-stagger-4" data-testid="ssrte-widget-empty">
        ...
        <div className="p-8 text-center">
          <Shield className="h-8 w-8 mx-auto mb-3 text-[#9CA3AF]" strokeWidth={1.5} />
          <p className="text-sm font-medium text-[#374151]">Aucune donnee SSRTE</p>
          <p className="text-xs text-[#9CA3AF] mt-1">Les donnees apparaitront apres les premieres evaluations terrain</p>
        </div>
      </div>
    );
  }
