...
from routes import ars1000_pdc, ars1000_lots, ars1000_certification, ars1000_agroforesterie, ars1000_analytics
...
if CORS_ORIGINS:
    ...
    allowed_origins = [
        "https://pdc-cocoa-preview.preview.emergentagent.com",
        "http://localhost:3000",
        "http://localhost:8001",
