...
from routes import ars1000_lots, ars1000_certification, ars1000_agroforesterie, ars1000_analytics
...
from routes import institutional_pdf
...
app.include_router(institutional_pdf.router)
...
app.include_router(ars1000_analytics.router)
...
app.include_router(risques_durabilite.router)
...
if CORS_ORIGINS:
    ...
    allowed_origins = [
        "https://cooperative-modules.preview.emergentagent.com",
        "http://localhost:3000",
        "http://localhost:8001",
